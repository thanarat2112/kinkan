...
<html lang="en">
    ...
    <br><br><br><br>
    <center><h1 class="alert alert-info">สถานะการสั่งซื้อ</h1></center>
    <center><a href="reportall.php"><button class="btn btn-outline-primary">สถานะการสั่งซื้อทั้งหมด</button></a> <a href="recon.php"><button class="btn btn-outline-success">ชำระแล้ว</button></a> <a href="recan.php"><button class="btn btn-outline-danger">ยกเลิกแล้ว</button></a> <a href="report.php"><button class="btn btn-outline-warning">ยังไม่ได้ชำระ</button></a></center><br>
    ...
    <br><table class="table table-hover">
        ...
        <?php
         ...
         if($key_word !=""){
            $read = "SELECT * FROM tb_order  WHERE order_id='$key_word' OR cus_name LIKE '%$key_word%' ORDER BY order_id DESC ";
         }else{
            $read = "SELECT * FROM tb_order  order by reg_date DESC";
         }
